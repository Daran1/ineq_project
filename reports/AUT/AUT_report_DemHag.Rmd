...
kable(table1, caption = "Table 1: Pre-tax factor income")
```
...
```{r echo=FALSE}
kable(readRDS("tables/_tables_AUT_p1_2.rds"))
```
...
```{r echo=FALSE}
kable(readRDS("tables/_tables_AUT_p1_3.rds"))
```
...
```{r echo=FALSE}
kable(readRDS("tables/_tables_AUT_p2_1.rds"))
```
...
```{r echo=FALSE}
kable(readRDS("tables/_tables_AUT_p2_2.rds"))
``` 
...
```{r echo=FALSE}
kable(readRDS("tables/_tables_AUT_p2_3.rds"))
```
