...
kable(table3, caption = "Pre-tax factor income")
```
...
kable(table4, caption = "Pre-tax factor income")
```
...
kable(table5, caption = "Pre-tax factor income")
```
...
kable(table6, caption = "Pre-tax factor income")
```
