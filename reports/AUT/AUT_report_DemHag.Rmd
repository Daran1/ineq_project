...
Dies zeigt sich auch durch den hohen Anteil des Einkommens der durch die höchsten zehn Prozent verdient wird. Dieser Anteil weist ebenfalls eine Steigerung von einem sehr hohen Ausgangsniveau von 0,31 auf 0,34 auf. Auch die Einkommensquantilsanteile weisen  einen starken Anstieg auf, zwischenzeitlich sogar bis auf 697.5. Das bedeutet, orientiert man sich lediglich am Faktoreinkommen, so verdienen die obersten 20 Prozent 615 mal so viel wie die unteren 20 Prozent. 
...
Wie in der Analyse der anderen Grundgesamtheit sind auch in diesem Einkommenskonzept Mittelwert und Median um einen ähnlichen Betrag höher. Der Gini-Koeffizient ist mit 0.44 im Jahr 2017 jedoch noch relativ hoch. In Relation zum obigen Vergleichswert mit anderer Grundgesamtheit ist die 20/80 Share Ratio höher, jedoch der Anteil der obersten 10% am Einkommen ähnlich. 
...
Meistens wir die Armutsgefährdung auch in unterschiedlichen Altersgruppen ausgewiesen. Dadurch kann ein Überblick über die Zusammensetzung der Einkommen verschiedener Bevölkerungsschichten erschaffen werden. Im Europäischen Vergleich ist im Jahr 2017 die "At-Risk-of-Poverty Rate" der Bevölkerung unter 18 Jährigen mit 20,2% am höchsten gewesen. Im Vergleich dazu haben die über 65 Jährigen eine Armutsgefähdungsquote von 15,0% gehabt. Leicht unter der gesamten Quote von 16,9% (@eurostat2). 

Abbildung 6 veranschaulicht den zeitlichen Verlauf der Armutsgefährdungsquote für drei unterschiedliche Altergruppen: Unter 18-Jährige, 18- bis 65-Jährige und über 65-Jährige. Dabei lassen sich im Vergleich zur nach Geschlechtern unterteilten Veranschaulichung unterschiedliche Trends ablesen. Wie zu erwarten haben Personen im erwerbsfähigen Alter (18 bis 64) die geringste Armutsgefährdungsquote. Diese Quote bleibt mit Ausnahme eines Anstiegs im Jahr 2008 stabil.

Die beiden anderen Altergruppen starten auf einem ähnlichen Niveau zu einander, verhalten sich im Zeitverlauf aber relativ unterschiedlich. Während die Armutsgefährdungsquote der Personen im Pensionsalter im Zeitverlauf signifikant abnimmt, ist für die Jugendliche und Kinder unter 18 Jahren eine Steigerung abzulesen. Alle drei Altersgruppen weisen einen signifikanten Anstieg im Krisenjahr 2008 auf.

![](img/povage){width=80%}

### Table : Armutsgefährdungsquote nach Alter und Geschlecht

Im folgenden befindet sich eine Tabelle welche die Armutsgefährdungsqouten für Österrecih aufweist. Dabei wird diese in verschiedenen Gruppen dargestellt. Einersetis wird die Insgesamte "At-Risk-of-Poverty Rate" ausgewiesen, daneben befinden sich die Daten für Männer und Frauen sowie eine unterteilung auf die Altersgruppen der unter 18 Jährigen, der 18-64 Jährigen, sowie der 65Jährigen und älteren. Somit werden die oben gezeigten Ergebnisse durch diese Tabellenansicht verdeutlich und belegt. 
...
Zusammenfassend lässt sich festhalten, dass das österreichische Steuersystem einen großen Beitrag zur Umverteilung von Einkommen in Österreich beiträgt. Wie sich anhand der in dieser Seminararbeit durchgeführten Berechnungen zeigen lässt werden die ausgewählten Ungleichheitsindikatoren durch Steuern wesentlich gesenkt. Die Werte der Indikatoren hängen stark von der Wahl des Einkommenskonzeptes ab und variieren dementsprechend stark in den Berechnungen, verhalten sich zum Großteil im letzten Jahrzehnt jedoch stabil und haben sich nicht wesentlich verschlechtert. 

Betreffend der Armutsgefährdungsquote zeigt sich ein differenzierteres Bild. Diese stieg für alle untersuchten Gruppen im Jahr 2008 rapide an und hat sich ihrem Vorkrisenniveau seitdem nicht angenähert. Besonders besorgniserregend ist nach Ansicht der Autoren hierbei der doch ausgeprägte Unterschied zwischen Männern und Frauen sowie der starke Anstieg der Armutsgefährdungsquote für Kinder und Jugendliche unter 18 Jahren.
